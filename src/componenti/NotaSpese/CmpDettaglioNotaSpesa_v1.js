                      ...
                      <div className="container">
                        ...
                        <div className="row">
                          <div className="col-6">
                            <Form.Group className="mb-3">
                              <Form.Label className="labelFieldnk">
                                Allegato 1 - nome file
                              </Form.Label>
                              <Form.Control
                                className="textFieldnk"
                                size="sm"
                                type="text"
                                value={nota.allegato1_nome_file || ""}
                                onChange={(evt) =>
                                  this.cambioProprietaNotaSpesa(
                                    "allegato1_nome_file",
                                    evt.target.value,
                        ...
                        <div className="row">
                          <div className="col-6">
                            <Form.Group className="mb-3">
                              <Form.Label className="labelFieldnk">
                                Allegato 2 - nome file
                              </Form.Label>
                              <Form.Control
                                className="textFieldnk"
                                size="sm"
                                type="text"
                                value={nota.allegato2_nome_file || ""}
                                onChange={(evt) =>
                                  this.cambioProprietaNotaSpesa(
                                    "allegato2_nome_file",
                                    evt.target.value,
